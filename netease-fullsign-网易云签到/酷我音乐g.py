...
3. 备注格式：备注 #手机号# 密码
4. 多账号用 `&` 分隔:  
KWYY="备注 #1 手机号 1# 密码 1 & 备注 2# 手机号 2# 密码 2"
...
SIGN_BASE = '[https://integralapi.kuwo.cn/api/v1/online/sign](https://link.wtturl.cn/?target=https%3A%2F%2Fintegralapi.kuwo.cn%2Fapi%2Fv1%2Fonline%2Fsign&scene=im&aid=497858&lang=zh)'
...
FREEMIUM_SWITCH_URL = '[https://wapi.kuwo.cn/openapi/v1/user/freemium/h5/switches](https://link.wtturl.cn/?target=https%3A%2F%2Fwapi.kuwo.cn%2Fopenapi%2Fv1%2Fuser%2Ffreemium%2Fh5%2Fswitches&scene=im&aid=497858&lang=zh)'
...
url = '[http://ar.i.kuwo.cn/US_NEW/kuwo/login_kw](https://link.wtturl.cn/?target=http%3A%2F%2Far.i.kuwo.cn%2FUS_NEW%2Fkuwo%2Flogin_kw&scene=im&aid=497858&lang=zh)'
...
'Host': '[ar.i.kuwo.cn](https://link.wtturl.cn/?target=https%3A%2F%2Far.i.kuwo.cn&scene=im&aid=497858&lang=zh)',
...
url = '[https://integralapi.kuwo.cn/api/v1/online/sign/new/newBoxFinish](https://link.wtturl.cn/?target=https%3A%2F%2Fintegralapi.kuwo.cn%2Fapi%2Fv1%2Fonline%2Fsign%2Fnew%2FnewBoxFinish&scene=im&aid=497858&lang=zh)'
...
'Host': '[integralapi.kuwo.cn](https://link.wtturl.cn/?target=https%3A%2F%2Fintegralapi.kuwo.cn&scene=im&aid=497858&lang=zh)',
...
'Origin': '[https://h5app.kuwo.cn](https://link.wtturl.cn/?target=https%3A%2F%2Fh5app.kuwo.cn&scene=im&aid=497858&lang=zh)',
...
'Referer': '[https://h5app.kuwo.cn/](https://link.wtturl.cn/?target=https%3A%2F%2Fh5app.kuwo.cn%2F&scene=im&aid=497858&lang=zh)',
...
url = '[https://integralapi.kuwo.cn/api/v1/online/sign/v1/earningSignIn/newDoListen](https://link.wtturl.cn/?target=https%3A%2F%2Fintegralapi.kuwo.cn%2Fapi%2Fv1%2Fonline%2Fsign%2Fv1%2FearningSignIn%2FnewDoListen&scene=im&aid=497858&lang=zh)'
...
url = '[https://integralapi.kuwo.cn/api/v1/online/sign/loterry/getLucky](https://link.wtturl.cn/?target=https%3A%2F%2Fintegralapi.kuwo.cn%2Fapi%2Fv1%2Fonline%2Fsign%2Floterry%2FgetLucky&scene=im&aid=497858&lang=zh)'
...
print ('⏭️ 听歌分段任务：未发现分段配置（listenList 为空或结构变更）')
...
url = '[http://www.pushplus.plus/send](https://link.wtturl.cn/?target=http%3A%2F%2Fwww.pushplus.plus%2Fsend&scene=im&aid=497858&lang=zh)'
...
print ('❌ PushPlus 推送失败: ' + str (result.get ('msg', ' 未知错误 ')))

return False

except Exception as e:

print ('❌ PushPlus 推送异常: ' + str (e))

return False

def should_push():

"""判断是否应该推送（12:00-12:15 和 23:55-23:59 窗口推送，或设置 FORCE_PUSH=1 强制推送）"""
...
DAILY_GOLD_FILE = os.path.join(os.path.dirname(os.path.abspath(**file**)), 'daily_gold_data.json')
...
print (' 格式 1: KWYY="手机号 #密码"')

print (' 格式 2: KWYY="备注 #手机号# 密码"')
...
print ('  第 ' + str (round_idx) + '/9 次 ✅ ' + reward_name + ' (+' + str (obtain) + ' 金币)')

else:

print ('  第 ' + str (round_idx) + '/9 次 ✅ ' + reward_name)

else:

print ('  第 ' + str (round_idx) + '/9 次 ❌ ' + str (lottery_result ['message']))
